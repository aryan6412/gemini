...
description: Critical security engineering rules and vulnerability prevention guidelines. Use when writing, refactoring, or reviewing code to prevent secrets exposure, injection, insecure database/storage rules, and authorization bypasses.
---

# Security Guidelines & Vulnerability Prevention
